...
if is_finded("obfs-local") then ss_plugin:value("simple-obfs") end
...
ss_plugin_simple_obfs_opts = s:option(Value, "ss_plugin_simple_obfs_opts", translate("opts"))
ss_plugin_simple_obfs_opts:depends("ss_plugin", "simple-obfs")
